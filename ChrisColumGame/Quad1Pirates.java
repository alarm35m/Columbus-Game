...
public class Quad1Pirates implements PirateComponent, Runnable{
	 ...
	 */
	public Quad1Pirates(int scalingFactor) {
		int x = 0;
		int y = 0;
		for (int i = 0; i < 5; i++) {
	...
	//gets the size of composite list
	public int getListSize() {
		return quad1List.size();
	}
